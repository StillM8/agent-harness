...
agent-harness v2.1.0 ships with conservative defaults that build a fast, demand-driven catalog (~11,500+ entries from 50+ configured sources, including asset-producing sources). This guide describes how to build a truly comprehensive catalog across millions of available assets for production use.
